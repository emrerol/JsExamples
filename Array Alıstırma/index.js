...
// const firstInventors = inventors.filter(
//   (inventor) => inventor.year >= 1500 && inventor.year <= 1599
// );

// console.table(firstInventors);
//#endregion
...
// const oldToYoung = inventors.sort((first, second) =>
...
// const list = Array.from(category.querySelectorAll("a"));
// const de = list.map((l) => l.textContent);
// const is = de.filter((names) => names.includes("de"));

// 7. sort Exercise
// Sort the people alphabetically by last name
// const alphabetically = people.sort((last, next) => {
